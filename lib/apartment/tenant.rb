...
module Apartment
  ...
  module Tenant
    ...
    def_delegators :adapter, :create, :current_tenant, :current, :current_database, :default_tenant, :drop, :switch, :process_excluded_models, :reset, :seed, :switch!, :base_switch, :base_switch!
